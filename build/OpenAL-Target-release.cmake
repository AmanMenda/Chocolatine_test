...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET OpenAL::OpenAL
                 ...
                 $<$<CONFIG:Release>:${openal-soft_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${openal-soft_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${openal-soft_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${openal-soft_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${openal-soft_COMPILE_OPTIONS_RELEASE}> APPEND)
